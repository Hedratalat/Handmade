    ...
    <>
      {visible && (
        <button
          ...
          className="bg-terracotta text-cream rounded-full w-10 h-10 flex items-center justify-center 
      fixed right-4 bottom-4 z-50 hover:bg-terracottaDark transition-colors"
        >
